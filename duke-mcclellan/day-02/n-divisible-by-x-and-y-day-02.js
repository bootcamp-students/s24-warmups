...
/* Ember's Feedback:
    Good job!
    The ternary operator here is an unnecessary step, you can just return the output from &&
    The logical and operator will resolve to a boolean value already so you can just let it give you true or false.
*/
...
/*
  ...
  n is an expression, it is telling JS to resolve the value stored in variable n to perform an operation with it
