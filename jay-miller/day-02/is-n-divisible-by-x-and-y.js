...
/*
  Ember's Feedback:
  Submissions don't count without pseudocode

  Ternary expression is unneeded here, you can just return the output for the parenthesis because
  it is already a boolean value
