...
/* Ember's Feedback:
  Great job!
  The if statement here is superfluous, because the logical and (&&) will resolve to a boolean for you already.
  You can just put a return statement where the if is and it will return true or false
*/
function isDivisible(n, x, y) {
