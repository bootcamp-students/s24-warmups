...
def comp(array1, array2):
    ...
    for num in array1: # loop
        ...
        if squared in squared_a: # if the number already exists increase its count {121: 1}
            squared_a[squared] += 1
        else:
            squared_a[squared] = 1 # if the number is not in the dictionary we make it a value
    ...
    for num in array2: # loop
        if num in b_list:
            ...
            b_list[num] = 1 # if num does not exist put it into dictionary with a count of 1
