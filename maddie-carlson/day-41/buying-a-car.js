function nbMonths(startPriceOld, startPriceNew, savingperMonth, percentLossByMonth){
  ...
  while (totalSavings + startPriceOld < startPriceNew) {
    ...
    if (months % 2 === 0) { //on even months, percent loss increases
    ...
    console.log("month: ", months, " percent_loss: ", percentLossByMonth, " available: ", startPriceOld + totalSavings - startPriceNew)
  }
