...
# Concern- I use the wrong method or my math will be completly off
# Explain I set each variable to equal to the total divided by the amount of its value.
# as I move down the list of variables, add each bigger value to the variable to it as well 
